...
class ResetPasswordController extends AbstractController
{
...

    {
        ...
        if ($request->get('email')) {
            ...
            if ($user){
                ...
                $this->addFlash('notice', 'vous allez recevoir dans quelque secondes un mail avec le procédure pour rénitialiser votre mot de passe');
            }else {
    ...
    public function update(Request $request, $token, UserPasswordEncoderInterface $encoder)
    {
        ...
        if($now > $reset_password->getCreatedAt()->modify('+3 hour')) {
            ...
            $this->addFlush('notice', 'votre demande de mot de passe a expiré. Merci de la renouveller');
            return $this->redirectToRoute('reset_password');
        }
        ...
        if($form->isSubmitted() && $form->isValid()) {
            ...
            $this->entityManager->flush();
             ...
             //Reddirection de l'utilisateur vers la page de connection.
